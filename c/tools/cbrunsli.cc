...
void error_usage(){
    fprintf(stderr, "Usage: cbrunsli FILE [OUTPUT_FILE, default=FILE.brn] --bench\n");
    exit(EXIT_FAILURE);
}
...
int main(int argc, char** argv) {
    ...
    std::string outfile_name = file_name + ".brn";
    ...
    bool ok = BrunsliEncoder(SplitEncoder(), bench).encode(file_name, outfile_name);
